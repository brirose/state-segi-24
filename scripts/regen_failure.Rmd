...
Here, I make a layer that represents seed source (grove area that has not experienced rdnbr 640 or higher fire). Then I use this to find areas where dispersal is likely by adding a 67.8m buffer.
