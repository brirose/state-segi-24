...
cbi_windy <- rast(here("data/spatial_data/inputs/fire/windy_2021_ravg_data/ca3604711863120210910_20201018_20211015_rdnbr_cbi4.tif"))%>% 
  project(crs(cbi2017))

cbi_windy_missing <- mask(cbi_windy, cbi_missing, inverse = T) %>%  
...
cbi_additional <- bind_rows(cbi_missing, cbi_windy_missing)
...
cbi_all <- cbi_all %>% select(id,year, burnsev, assss_t, geometry)
