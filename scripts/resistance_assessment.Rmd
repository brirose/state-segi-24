...
write_sf(resist_shp, here("data/spatial_data/outputs/resist_tests/SoSEGI_resist_map_23Feb25_BriCode.shp"))
...
resist_shp = dist_hist %>% 
  ...
  mutate(time_bin = case_when(last_trt < 2015 & resist_class == "High resistance" ~ ">10 years",
                         ...
                         last_trt >= 2015 & last_trt <2020 & 
                           resist_class == "Moderate resistance" ~ "5-10 years",
