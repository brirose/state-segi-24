...
dat[[8]][["ucb_year"]] <- as.numeric(dat[[8]][["ucb_year"]])
```
...
trt_combined <- list_rbind(dat) #combine!

st_write(trt_combined, here("data/spatial_data/outputs/SEGITrtdata_30Jan25.shp"))
