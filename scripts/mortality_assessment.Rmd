...
monarchs_severity <- monarchs_severity %>% 
  ...
  select(tree_id, grove, postfire_status, prefire_status, survey_year, survey_fire, fire_id, fire_yr, burnsev, source) 
...
```{r compare_sti_groves, fig.width=10, fig.height=14}
