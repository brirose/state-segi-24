...
```{r}
#Meyer input
#these points are all ~15m off from the monarch. unclear whether this was done in a consistent direction
...
monarchs_severity <- monarchs_binary %>% 
  st_join(sev_ba) #need to make sure only keeps more recent fire
