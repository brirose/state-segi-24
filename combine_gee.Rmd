...
rasfiles <- list.files(path=here("data/spatial_data/inputs/fire/fires_needed"), full.names=T)

rasnames <- mgsub(rasfiles, c("data/spatial_data/inputs/fire/fires_needed",".tiff"), c("","")) 
...
writeRaster(severity_rdnbr, here("data/spatial_data/needFires_rdnbr.tif"))

severity_rdnbr <- rast(here("data/spatial_data/needFires_rdnbr.tif"))
...
dir.create("data/spatial_data/needSeverity_baClass4")

writeRaster(severity_ba4, here("data/spatial_data/needSeverity_baClass4/needSeverity_baClass4.tif"))
