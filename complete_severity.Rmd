...
rdnbr_segi_rast <- rast("data/spatial_data/outputs/needFires_rdnbr/needFires_rdnbr.tif")
...
ba_windy <- rast("data/spatial_data/inputs/fire/windy_2021_ravg_data/ca3604711863120210910_20201018_20211015_rdnbr_ba4.tif") %>% 
  project(crs(ba2017))
...
ba_additional <- st_union(ba_additional, ba_windy_missing)
...
dir.create("data/spatial_data/outputs/ba_segi_all")
st_write(ba_segi_all, "data/spatial_data/outputs/ba_segi_all/ba_segi_all.shp", append = F)
...
#dir.create("data/spatial_data/outputs/ba_full_all")
st_write(ba_full, "data/spatial_data/outputs/ba_full_all/ba_full_all.shp", append = F)
```
